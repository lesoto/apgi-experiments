...
This module consolidates all theme management functionality including:
- AdvancedThemeManager: Full-featured theme management
- ThemeManager: Backward compatibility wrapper for legacy code
"""
...
class ThemeManager:
    ...
    DEPRECATED: Use AdvancedThemeManager directly for new code.
    """
    ...
    def __init__(
        ...
        warnings.warn(
            "ThemeManager is deprecated. Use AdvancedThemeManager for new code.",
            DeprecationWarning,
            stacklevel=2,
        )
        ...
        if system == "Windows":
            try:
                ...
                with winreg.OpenKey(
                    ...
                    return "dark" if not apps_use_light_theme else "light"
            except Exception:
                pass
        elif system == "Darwin":  # macOS
            try:
