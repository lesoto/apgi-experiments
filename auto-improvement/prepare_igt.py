...
Usage:
    python prepare_igt.py  # Verify deck configurations
...
class IGTExperiment:
    ...
    def __init__(self, num_trials: int = NUM_TRIALS):
        ...
        self.decks = {label: IGTDeck(label) for label in DECK_LABELS}
        self.trials: List[IGTrial] = []
    ...
    def run_trial(self, deck_choice: str, reaction_time_ms: float = 0.0) -> IGTrial:
        """
...
if __name__ == "__main__":
    ...
    exp = IGTExperiment(num_trials=100)
