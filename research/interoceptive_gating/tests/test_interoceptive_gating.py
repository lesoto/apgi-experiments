...
class TestInteroceptiveGating:
    ...
    def experiment(self):
        ...
        exp = InteroceptiveGatingExperiment(
            n_participants=1,
            sample_rate=1000
        )
    ...
    def test_initialization(self, experiment):
        ...
        assert set(experiment.conditions) == {'interoceptive', 'exteroceptive', 'control'}
    ...
    def test_visualization(self, experiment):
        ...
        if not (hasattr(experiment, 'plot_thresholds') and 
                hasattr(experiment, 'plot_accuracy') and 
                hasattr(experiment, 'plot_rt')):
