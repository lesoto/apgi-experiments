...
```bash
python apgi_framework/experimental/example_threshold_estimation.py
```
...
- APGI Framework Requirements Document
- APGI Framework Design Document
- APGI Testable Predictions Document
