...
class TestPredictiveIgnitionNetwork:
    ...
    def test_forward_pass_no_ignition(self):
        ...
        network = PredictiveIgnitionNetwork(n_features=10, n_global_units=5, threshold=10.0, alpha=2.0)
        
        # Use small input to avoid ignition
        sensory_input = np.random.randn(10) * 0.1
        somatic_gain = 1.0
        
        predictions, errors, weighted_errors, ignited, ignition_prob = network.forward_pass(sensory_input, somatic_gain)
    ...
    def test_forward_pass_with_ignition(self):
        ...
        network = PredictiveIgnitionNetwork(n_features=10, n_global_units=5, threshold=1.0, alpha=2.0)
    ...
    def test_prediction_error_calculation(self):
        ...
        network = PredictiveIgnitionNetwork(n_features=5, n_global_units=3, threshold=2.0, alpha=2.0)
    ...
    def test_global_activation_update(self):
        ...
        network = PredictiveIgnitionNetwork(n_features=5, n_global_units=3, threshold=1.0, alpha=2.0)
    ...
    def test_multiple_forward_passes(self):
        ...
        for i, sensory_input in enumerate(inputs):
            predictions, errors, weighted_errors, ignited, prob = network.forward_pass(sensory_input, somatic_gain=1.0)
...
class TestModelIntegration:
    ...
    def test_network_to_agent_communication(self):
        ...
        _, errors, weighted_errors, ignited, ignition_prob = network.forward_pass(sensory_input, somatic_gain)
