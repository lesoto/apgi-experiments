...
class TestIntegratedDataManager:
    ...
    def test_create_visualization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            summary = StatisticalSummary(
                total_trials=1000,
                falsification_rate=0.15,
                mean_p3b_amplitude=5.2
            )
    ...
    def test_query_experiments(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            falsified_experiments = manager.query_experiments(filters={"falsified": True})
...
class TestDataExporter:
    ...
    def test_export_experimental_trials(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from apgi_framework.core.data_models import ExperimentalTrial, APGIParameters, NeuralSignatures, ConsciousnessAssessment
            trials = [
                ExperimentalTrial(
                    trial_id="trial_001",
                    participant_id="P001",
...
class TestReportGenerator:
    ...
    def test_generate_falsification_report(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Mock data
            from apgi_framework.core.data_models import FalsificationResult, ExperimentalTrial, StatisticalSummary
    ...
    def test_save_report(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from apgi_framework.data.report_generator import FalsificationReport, ReportSection
            from apgi_framework.core.data_models import StatisticalSummary
