...
from apgi_framework.adaptive.stimulus_generators import (
    ...
    CO2PuffParameters, GaborPatchGenerator, ToneGenerator
)
...
class TestGaborPatchGenerator:
    """Test Gabor patch generator implementation."""
    ...
    def test_generate_stimulus(self):
        ...
        # Test generation (may return success boolean)
        result = generator.generate_stimulus(params)
        assert isinstance(result, bool)  # Generator returns success status
