...
class TestPCISignature:
    ...
    def test_pci_signature_creation(self):
        ...
        assert signature.complexity_components == {
            "lzc": 0.3, "perturb_complexity": 0.4, "integration": 0.5, "differentiation": 0.6
        }
...
class TestPCICalculator:
    ...
    def test_generate_conscious_signature_custom_params(self):
        ...
        assert signature.connectivity_strength > 0.7  # Should be close to specified value
    ...
    def test_calculate_complexity_components(self):
        ...
        components = self.calculator._calculate_complexity_components(response, connectivity)
