...
from apgi_framework.clinical.parameter_extraction import (
    ModalityType, TaskType, ClinicalParameters, ClinicalParameterExtractor, 
    ReliabilityMetrics
)
...
class TestDisorderClassification:
    ...
    def test_train_classifier(self):
        ...
        labels = [DisorderType.GAD, DisorderType.CONTROL, DisorderType.GAD, DisorderType.CONTROL, DisorderType.GAD, DisorderType.CONTROL]
    ...
    def test_classify(self):
        ...
        test_profile = NeuralSignatureProfile(
            p3b_amplitude_extero=4.5,
            p3b_amplitude_intero=2.8,
            gamma_power_frontal=0.18
        )
