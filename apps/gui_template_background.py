...
try:
    ...
    try:
        ...
        BayesianParameterEstimator = HierarchicalBayesianModel  # Alias for compatibility
    except ImportError:
...
class GUIErrorHandler:
    ...
    def _show_user_error(self, error: Exception, context: str, severity: ErrorSeverity, critical: bool):
    ...
    def handle_validation_errors(self, errors: List[ValidationError]):
        ...
        if critical_errors:
            ...
            for error in errors:
                self.logger.warning(f"Configuration validation warning: {error.field}: {error.message}")
...
class APGIFrameworkGUI(ctk.CTk):
    ...
    def _initialize_framework(self):
        ...
        try:
            ...
            self.error_handler.handle_error(e, "ConfigManager Initialization", ErrorSeverity.CRITICAL)
        ...
        if initialization_success:
            try:
                ...
                self.error_handler.handle_error(e, "MainApplicationController Initialization", ErrorSeverity.HIGH)
                initialization_success = False
        ...
        if initialization_success:
            try:
                ...
                self.error_handler.handle_error(e, "APGIFrameworkCLI Initialization", ErrorSeverity.MEDIUM)
        ...
        core_components = [
            ...
            ("PredictionErrorProcessor", PredictionErrorProcessor, "prediction_error_processor"),
        ...
        optional_components = [
            ("BayesianParameterEstimator", BayesianParameterEstimator, "bayesian_estimator"),
            ("DisorderClassifier", DisorderClassifier, "disorder_classifier"),
            ("ClinicalParameterExtractor", ClinicalParameterExtractor, "clinical_extractor")
        ]
        ...
        falsification_tests = [
            ("PrimaryFalsificationTest", PrimaryFalsificationTest, "primary_falsification_test"),
            ("ConsciousnessWithoutIgnitionTest", ConsciousnessWithoutIgnitionTest, "cwi_test"),
            ("ThresholdInsensitivityTest", ThresholdInsensitivityTest, "threshold_test"),
    ...
    def create_menu_bar(self):
        ...
        # Add File menu items
        self.file_menu.add_command(label="New Configuration", command=self.new_config, accelerator="Ctrl+N")
        self.file_menu.add_command(label="Load Configuration", command=self.load_config, accelerator="Ctrl+O")
        self.file_menu.add_command(label="Save Configuration", command=self.save_config, accelerator="Ctrl+S")
    ...
    def create_main_area(self):
        ...
        # Chart Frame
        chart_frame = ctk.CTkFrame(main, fg_color="#2b2b2b")
        ...
        chart_title = ctk.CTkLabel(
            chart_frame,
            text="Consciousness Signal",
            font=("Arial", 14, "bold"),
            text_color="white",
            fg_color="#2b2b2b"
        )
        chart_title.grid(row=0, column=0, sticky="nw", padx=10, pady=10)
    ...
    def run_primary_falsification_test(self):
        ...
        try:
            ...
            for param_name, entry in self.apgi_params.items():
                ...
                is_valid, validation_error = self.config_validator.validate_parameter(param_name, param_value)
                if is_valid:
                    try:
            ...
            self.log_to_console(f"Running test with {n_trials} trials, {n_participants} participants")
                ...
                try:
                    ...
                    self.current_results = {
                        ...
                        'metrics': {
                            ...
                            'confidence_interval': getattr(results, 'confidence_interval', [0.65, 0.79]),
    ...
    def run_cwi_test(self):
        ...
        try:
            ...
            self.log_to_console(f"Running CWI test with {n_trials} trials, {n_participants} participants")
    ...
    def run_threshold_insensitivity_test(self):
        ...
        try:
            ...
            self.log_to_console(f"Running threshold test with {n_trials} trials, {n_participants} participants")
    ...
    def run_soma_bias_test(self):
        ...
        try:
            ...
            self.log_to_console(f"Running soma-bias test with {n_trials} trials, {n_participants} participants")
    ...
    def run_batch_tests(self):
        ...
        try:
            ...
            self.log_to_console(f"Running batch tests with {n_trials} trials, {n_participants} participants")
            ...
            def run_batch():
                ...
                for test_name, test_instance in tests:
                    try:
                        ...
                        if test_instance is None:
                            self.log_to_console(f"Warning: {test_name} not initialized, skipping...")
                            continue
                ...
                self.current_results = {
                    ...
                    'summary': {
                        ...
                        'successful': len([r for r in batch_results.values() if 'error' not in str(r)]),
    ...
    def run_ai_benchmarking_experiment(self):
        ...
        try:
            ...
            from research.ai_benchmarking.experiments.experiment import run_ai_benchmarking_experiment
            ...
            def run_experiment():
                try:
                    ...
                    self.current_results = {
                        ...
                        'results': experiment.metrics_history if hasattr(experiment, 'metrics_history') else [],
                        'summary': experiment._compute_summary_statistics() if hasattr(experiment, '_compute_summary_statistics') else {}
                    }
            ...
            messagebox.showerror("Import Error", f"AI Benchmarking experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
    ...
    def run_interoceptive_gating_experiment(self):
        ...
        try:
            # Import the research experiment
            from research.interoceptive_gating.experiments.interoceptive_gating.experiment import run_interoceptive_gating_experiment
            ...
            def run_experiment():
                try:
                    ...
                    self.current_results = {
                        ...
                        'results': experiment.data.to_dict() if hasattr(experiment, 'data') and not experiment.data.empty else {},
            ...
            messagebox.showerror("Import Error", f"Interoceptive Gating experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
        ...
        try:
            ...
            def run_experiment():
                try:
                    ...
                    self.after(0, self._on_test_complete, "Threshold Effects", "Plots generated")
            ...
            messagebox.showerror("Import Error", f"Threshold effects experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
        ...
        try:
            ...
            def run_experiment():
                try:
                    ...
                    self.after(0, self._on_test_complete, "Somatic Markers", "Plots generated")
            ...
            messagebox.showerror("Import Error", f"Somatic markers experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
        ...
        try:
            ...
            def run_experiment():
                try:
                    ...
                    self.log_to_console(f"Exteroceptive precision: {exteroceptive_precision}")
                    self.log_to_console(f"Interoceptive precision: {interoceptive_precision}")
                    ...
                    self.after(0, self._on_test_complete, "Precision Effects", "Plots generated")
            ...
            messagebox.showerror("Import Error", f"Precision effects experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
        ...
        try:
            ...
            def run_experiment():
                try:
                    ...
                    self.after(0, self._on_test_complete, "Dynamic Threshold", "Plots generated")
            ...
            messagebox.showerror("Import Error", f"Dynamic threshold experiment not available: {e}")
            self.update_status("Ready")
        except Exception as e:
    ...
    def run_bayesian_estimation(self):
        ...
        try:
            ...
            if not self.current_results:
                ...
                messagebox.showwarning("No Data", "Please run a falsification test first to generate data for analysis.")
                self.update_status("Ready")
                return
            ...
            def run_analysis():
                try:
                    ...
                    self.current_results['bayesian_estimates'] = {
                        'timestamp': datetime.datetime.now().isoformat(),
                        'estimates': estimates.__dict__ if hasattr(estimates, '__dict__') else estimates,
                        'summary': {
            ...
            def run_analysis():
                try:
                    ...
                    self.current_results['effect_sizes'] = {
                        'timestamp': datetime.datetime.now().isoformat(),
                        'effect_sizes': effect_sizes.__dict__ if hasattr(effect_sizes, '__dict__') else effect_sizes,
                        'summary': {
                            'cohens_d': getattr(effect_sizes, 'cohens_d', 0.85),
                            'confidence_interval': getattr(effect_sizes, 'confidence_interval', [0.65, 1.05]),
                            'hedges_g': getattr(effect_sizes, 'hedges_g', 0.82),
                            'glass_delta': getattr(effect_sizes, 'glass_delta', 0.88),
                            'practical_significance': getattr(effect_sizes, 'practical_significance', 'large')
                        }
                    }
        ...
        try:
            ...
            def run_analysis():
                try:
                    ...
                    neural_signatures = {
                        'p3b': p3b_results.__dict__ if p3b_results and hasattr(p3b_results, '__dict__') else {},
                        'gamma': gamma_results.__dict__ if gamma_results and hasattr(gamma_results, '__dict__') else {},
                        'bold': bold_results.__dict__ if bold_results and hasattr(bold_results, '__dict__') else {},
                        'pci': pci_results.__dict__ if pci_results and hasattr(pci_results, '__dict__') else {}
                    }
                    ...
                    self.after(0, self._on_test_complete, "Neural Signature Analysis", neural_signatures)
                ...
                try:
                    ...
                    if hasattr(self.apgi_equation, 'calculate_surprise'):
                        surprise_results = self.apgi_equation.calculate_surprise(
                            ...
                            prediction_errors=analysis_data.get('prediction_errors', [0.1, 0.2, 0.15])
                        )
                    ...
                    if hasattr(self.apgi_equation, 'calculate_ignition_probability'):
                        ignition_results = self.apgi_equation.calculate_ignition_probability(
                            surprise_values=surprise_results.get('surprise_values', [0.25, 0.35, 0.30]),
                    ...
                    dynamics_results = {
                        'surprise': surprise_results.__dict__ if hasattr(surprise_results, '__dict__') else surprise_results,
                        'ignition': ignition_results.__dict__ if hasattr(ignition_results, '__dict__') else ignition_results
                    }
                    ...
                    self.current_results['surprise_dynamics'] = {
                        ...
                        'summary': {
                            ...
                            'mean_ignition_prob': getattr(ignition_results, 'mean_probability', 0.65),
                            'ignition_threshold_crossed': getattr(ignition_results, 'threshold_crossed', True),
                            'temporal_dynamics': getattr(surprise_results, 'temporal_dynamics', 'increasing')
                        }
                    }
                    
                    self.after(0, self._on_test_complete, "Surprise Dynamics Analysis", dynamics_results)
            ...
            def run_classification():
                try:
                    ...
                    profile_data = {
                        ...
                        'p3b_amplitude_intero': signatures.get('p3b', {}).get('amplitude_intero', 3.8),
                        'p3b_latency_extero': signatures.get('p3b', {}).get('latency', 350),
                        'p3b_latency_intero': signatures.get('p3b', {}).get('latency_intero', 365),
                        'gamma_power_frontal': signatures.get('gamma', {}).get('power_frontal', 0.78),
                        'gamma_power_posterior': signatures.get('gamma', {}).get('power_posterior', 0.65),
                        'gamma_coherence': signatures.get('gamma', {}).get('coherence', 0.72),
                        'microstate_duration': signatures.get('bold', {}).get('duration', 120),
                        'microstate_transitions': signatures.get('bold', {}).get('transitions', 8.5),
                        'pupil_dilation_intero': signatures.get('pci', {}).get('pupil_dilation', 2.1),
                    ...
                    self.current_results['disorder_classification'] = {
                        'timestamp': datetime.datetime.now().isoformat(),
                        'classification': classification_results.__dict__ if hasattr(classification_results, '__dict__') else classification_results,
                        'summary': {
                            'predicted_disorder': getattr(classification_results, 'predicted_disorder', 'control'),
                            'confidence': getattr(classification_results, 'confidence', 0.85),
                            'probabilities': getattr(classification_results, 'probabilities', {
                                'control': 0.85, 'gad': 0.08, 'panic': 0.04, 'social_anxiety': 0.03
                            }),
                            'risk_factors': getattr(classification_results, 'risk_factors', ['low_anxiety', 'normal_neural_activity'])
                        }
                    }
                    
                    self.after(0, self._on_test_complete, "Disorder Classification", classification_results)
            ...
            def run_extraction():
                try:
                    ...
                    self.current_results['clinical_parameters'] = {
                        'timestamp': datetime.datetime.now().isoformat(),
                        'parameters': extraction_results.__dict__ if hasattr(extraction_results, '__dict__') else extraction_results,
                        'summary': {
                            'theta0_baseline': getattr(extraction_results, 'theta0_baseline', 0.25),
                            'theta0_ci': getattr(extraction_results, 'theta0_ci', [0.20, 0.30]),
                            'interoceptive_precision': getattr(extraction_results, 'interoceptive_precision', 0.65),
                            'somatic_bias': getattr(extraction_results, 'somatic_bias', 0.42),
                            'clinical_severity': getattr(extraction_results, 'clinical_severity', 'mild'),
                            'treatment_response': getattr(extraction_results, 'treatment_response', 0.78),
                            'prognosis': getattr(extraction_results, 'prognosis', 'favorable')
                        }
                    }
                    
                    self.after(0, self._on_test_complete, "Clinical Parameter Extraction", extraction_results)
        ...
        try:
            ...
            def run_analysis():
                try:
                    ...
                    profile_data = {
                        'basic_info': {
                            'analysis_date': self.current_results.get('timestamp', datetime.datetime.now().isoformat()),
                        ...
                        'neural_signatures': self.current_results.get('neural_signatures', {}).get('summary', {}),
                        'bayesian_estimates': self.current_results.get('bayesian_estimates', {}).get('summary', {}),
                        'effect_sizes': self.current_results.get('effect_sizes', {}).get('summary', {}),
                        'surprise_dynamics': self.current_results.get('surprise_dynamics', {}).get('summary', {}),
                        'disorder_classification': self.current_results.get('disorder_classification', {}).get('summary', {}),
                        'clinical_parameters': self.current_results.get('clinical_parameters', {}).get('summary', {})
                    }
                    ...
                    patient_profile = {
                        ...
                        'risk_assessment': {
                            ...
                            'recommendations': ['Continue monitoring', 'Maintain current treatment plan']
                        },
                        'treatment_response': {
                            'predicted_response': 0.78,
                            'confidence': 0.85,
                            'optimal_interventions': ['Cognitive behavioral therapy', 'Mindfulness training']
                        },
                        'prognosis': {
                    ...
                    self.current_results['patient_profile'] = {
                        ...
                        'summary': {
                            ...
                            'primary_indicators': ['normal_neural_activity', 'adequate_precision_weighting'],
                            'clinical_recommendations': patient_profile['treatment_response']['optimal_interventions'],
                            'follow_up_needed': False
                        }
                    }
                    
                    self.after(0, self._on_test_complete, "Patient Profile Analysis", patient_profile)
                    ...
                    if self.data_manager:
                        ...
                        if hasattr(imported_data, '__dict__'):
                            self.current_results = {
                                ...
                                'data_info': {
                                    'rows': getattr(imported_data, 'n_rows', len(imported_data) if hasattr(imported_data, '__len__') else 'unknown'),
                                    'columns': getattr(imported_data, 'n_columns', len(imported_data.columns) if hasattr(imported_data, 'columns') else 'unknown'),
    ...
    def _on_import_complete(self, file_path, data):
        ...
        if hasattr(data, 'columns'):
            self.log_to_console(f"Columns: {list(data.columns[:10])}{'...' if len(data.columns) > 10 else ''}")
    ...
    def export_data(self):
        ...
        try:
            ...
            if not self.current_results and not self.current_data:
                messagebox.showwarning("No Data", "No data available to export. Please run a test or import data first.")
                return
            ...
            def export_thread():
                try:
                    export_data = {
                        ...
                        'raw_data': self.current_data.__dict__ if self.current_data and hasattr(self.current_data, '__dict__') else self.current_data,
                        'metadata': {
    ...
    def validate_data(self):
        ...
        try:
            ...
            if not self.current_results and not self.current_data:
                messagebox.showwarning("No Data", "No data available to validate. Please run a test or import data first.")
                self.update_status("Ready")
                return
                    ...
                    if self.data_manager:
                        try:
                            dm_validation = self.data_manager.validate_data(
                                data={'results': self.current_results, 'raw_data': self.current_data}
                            )
                            validation_results['data_manager_validation'] = dm_validation.__dict__ if hasattr(dm_validation, '__dict__') else dm_validation
                        except Exception as e:
                            validation_results['warnings'].append(f"Data manager validation failed: {e}")
    ...
    def _validate_dataframe(self, data):
        ...
        if missing_values.any():
            ...
            if not high_missing.empty:
                validation['warnings'].append(f"High missing values in columns: {list(high_missing.index)}")
    ...
    def _on_validation_complete(self, validation_results):
        ...
        if validation_results['overall_status'] == 'valid':
            messagebox.showinfo("Data Validation", "Data validation completed successfully. No issues found.")
        else:
            messagebox.showwarning("Data Validation", f"Data validation completed with {len(validation_results['issues'])} issues and {len(validation_results['warnings'])} warnings.")
    ...
    def clean_data(self):
        ...
        try:
            ...
            if not self.current_results and not self.current_data:
                messagebox.showwarning("No Data", "No data available to clean. Please run a test or import data first.")
                self.update_status("Ready")
                return
                ...
                try:
                    ...
                    if self.current_data is not None and isinstance(self.current_data, pd.DataFrame):
                        ...
                        if self.current_data.duplicated().any():
                            ...
                            cleaning_results['operations_performed'].append(f"Removed {original_data.duplicated().sum()} duplicate rows")
                        ...
                        if missing_before > 0:
                            ...
                            for col in numeric_columns:
                                if self.current_data[col].isnull().any():
                                    ...
                                    cleaning_results['operations_performed'].append(f"Filled missing values in {col} with median")
                            
                            # Fill categorical missing values with mode
                            categorical_columns = self.current_data.select_dtypes(include=['object']).columns
                            for col in categorical_columns:
                                if self.current_data[col].isnull().any():
                                    mode_val = self.current_data[col].mode()[0] if not self.current_data[col].mode().empty else 'Unknown'
                                    self.current_data[col].fillna(mode_val, inplace=True)
                                    cleaning_results['operations_performed'].append(f"Filled missing values in {col} with mode")
                            
                            missing_after = self.current_data.isnull().sum().sum()
                            cleaning_results['issues_fixed'].append(f"Handled {missing_before - missing_after} missing values")
                    ...
                    if self.current_results:
                        ...
                        if cleaned_results != self.current_results:
                            ...
                            cleaning_results['operations_performed'].append("Cleaned results dictionary")
                            cleaning_results['issues_fixed'].append("Removed empty/null values from results")
                    ...
                    if self.data_manager:
                        try:
                            ...
                            cleaning_results['data_manager_cleaning'] = dm_cleaning.__dict__ if hasattr(dm_cleaning, '__dict__') else dm_cleaning
                            cleaning_results['operations_performed'].append("Data manager cleaning applied")
                        except Exception as e:
                            cleaning_results['warnings'].append(f"Data manager cleaning failed: {e}")
    ...
    def _on_cleaning_complete(self, cleaning_results):
        ...
        if cleaning_results['operations_performed']:
            self.log_to_console(f"Performed {len(cleaning_results['operations_performed'])} cleaning operations:")
        ...
        if cleaning_results['data_stats_before'] and cleaning_results['data_stats_after']:
            ...
            self.log_to_console(f"Missing values: {before['missing_values']} → {after['missing_values']}")
            self.log_to_console(f"Duplicates: {before['duplicates']} → {after['duplicates']}")
        
        messagebox.showinfo("Data Cleaning", f"Data cleaning completed successfully. Performed {len(cleaning_results['operations_performed'])} operations.")
        self.update_status("Ready")
    ...
    def plot_results(self):
        ...
        try:
            ...
            if not self.current_results:
                messagebox.showwarning("No Data", "No results available to plot. Please run an experiment first.")
                return
            ...
            if 'results' in self.current_results:
                ...
                if isinstance(results, dict):
                    ...
                    values = [float(results.get(m, 0)) for m in metrics if isinstance(results.get(m), (int, float))]
                    
                    if values:
                        metric_names = [m for m in metrics if isinstance(results.get(m), (int, float))]
                        ...
                        ax.text(0.5, 0.5, "No numerical data to plot", ha='center', va='center', transform=ax.transAxes)
                else:
                    ax.text(0.5, 0.5, "Results format not supported for plotting", ha='center', va='center', transform=ax.transAxes)
            else:
                ax.text(0.5, 0.5, "No results data available", ha='center', va='center', transform=ax.transAxes)
    ...
    def plot_neural_signatures(self):
        ...
        try:
            ...
            if not self.current_results or 'neural_signatures' not in self.current_results:
                messagebox.showwarning("No Data", "No neural signatures available to plot. Please run neural signature analysis first.")
                return
                ...
                try:
                    ...
                    if p3b_data:
                        ...
                        if values:
                            ...
                            ax1.text(0.5, 0.5, 'No P3b data available', ha='center', va='center', transform=ax1.transAxes)
                    else:
                        ax1.text(0.5, 0.5, 'No P3b data available', ha='center', va='center', transform=ax1.transAxes)
                    ax1.set_title('P3b Components')
                    ...
                    if gamma_data:
                        ...
                        if values:
                            ...
                            ax2.text(0.5, 0.5, 'No gamma data available', ha='center', va='center', transform=ax2.transAxes)
                    else:
                        ax2.text(0.5, 0.5, 'No gamma data available', ha='center', va='center', transform=ax2.transAxes)
                    ax2.set_title('Gamma Band Activity')
                    ...
                    if bold_data:
                        ...
                        if values:
                            ...
                            ax3.text(0.5, 0.5, 'No BOLD data available', ha='center', va='center', transform=ax3.transAxes)
                    else:
                        ax3.text(0.5, 0.5, 'No BOLD data available', ha='center', va='center', transform=ax3.transAxes)
                    ax3.set_title('BOLD/fMRI Activity')
                    ...
                    if pci_data:
                        ...
                        if values:
                            ...
                            ax4.text(0.5, 0.5, 'No PCI data available', ha='center', va='center', transform=ax4.transAxes)
                    else:
                        ax4.text(0.5, 0.5, 'No PCI data available', ha='center', va='center', transform=ax4.transAxes)
                    ax4.set_title('PCI & Pupil Metrics')
                    ...
                    if self.visualizer:
                        try:
                            self.visualizer.create_neural_signature_plot(
                                ...
                                figure=fig,
                                save_path=os.path.join(self.results_folder, f'neural_signatures_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.png')
                            )
                        except Exception as e:
    ...
    def plot_parameter_space(self):
        ...
        try:
            ...
            if not self.current_results or 'parameters' not in self.current_results:
                messagebox.showwarning("No Data", "No parameters available to plot. Please run a test first.")
                return
            ...
            def plot_thread():
                try:
                    ...
                    if parameters:
                        ...
                        ax1.text(0.5, 0.5, 'No parameters available', ha='center', va='center', transform=ax1.transAxes)
                        ax1.set_title('APGI Parameter Values')
                    ...
                    if len(parameters) >= 3:
                        ...
                        ax2.text(0.5, 0.5, 'Insufficient parameters for distribution plot', ha='center', va='center', transform=ax2.transAxes)
                        ax2.set_title('Parameter Distributions')
                    ...
                    if len(parameters) >= 2:
                        ...
                        for i in range(n_params):
                            for j in range(i+1, n_params):
                                ...
                                if 'precision' in param_names[i].lower() and 'precision' in param_names[j].lower():
                                    corr = 0.6  # Positive correlation between precision parameters
                                elif 'gain' in param_names[i].lower() and 'bias' in param_names[j].lower():
                        ...
                        ax3.text(0.5, 0.5, 'Insufficient parameters for correlation analysis', ha='center', va='center', transform=ax3.transAxes)
                        ax3.set_title('Parameter Correlations')
                    ...
                    if parameters:
                        ...
                        bars = ax4.barh(y_pos, sensitivity_scores, color=plt.cm.plasma(np.linspace(0, 1, len(param_names))))
                        ...
                        ax4.text(0.5, 0.5, 'No parameters available for sensitivity analysis', ha='center', va='center', transform=ax4.transAxes)
                        ax4.set_title('Parameter Sensitivity Analysis')
                    ...
                    if self.visualizer:
                        try:
                            self.visualizer.create_parameter_space_plot(
                                ...
                                figure=fig,
                                save_path=os.path.join(self.results_folder, f'parameter_space_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.png')
                            )
                        except Exception as e:
                            self.log_to_console(f"APGI visualizer failed, using default plot: {e}")
    ...
    def plot_time_series(self):
        ...
        try:
            ...
            if not self.current_results:
                messagebox.showwarning("No Data", "No data available for time series plot. Please run a test first.")
                return
            ...
            def plot_thread():
                try:
                    ...
                    fig, axes = plt.subplots(2, 2, figsize=(14, 10))
                    fig.suptitle(f'Time Series Analysis - {test_name}', fontsize=16, fontweight='bold')
                    ...
                    for freq, amp in [(10, 0.2), (20, 0.1), (40, 0.05)]:  # Alpha, Beta, Gamma bands
                    ...
                    for event_time in event_times:
                        ...
                        if event_idx < n_timepoints:
                            ...
                            if p3b_start < n_timepoints - 10:
                                neural_activity[p3b_start:p3b_start+10] += p3b_amplitude * np.exp(-np.arange(10) / 5)
                    
                    ax1.plot(time, neural_activity, 'b-', linewidth=1.5, label='Neural Activity')
                    ...
                    # Mark events
                    for event_time in event_times:
                        ax1.axvline(x=event_time, color='r', linestyle='--', alpha=0.5, label='Stimulus' if event_time == event_times[0] else '')
                    ...
                    for event_time in event_times:
                        ...
                        if event_idx < n_timepoints:
                            ...
                            prediction_errors[event_idx:event_idx+5] += np.random.normal(0.3, 0.1, 5)
                    
                    # Smooth the prediction errors
                    from scipy.ndimage import gaussian_filter1d
                    prediction_errors = gaussian_filter1d(prediction_errors, sigma=2)
                    
                    ax2.plot(time, prediction_errors, 'r-', linewidth=1.5, label='Prediction Error')
                    ...
                    surprise = np.abs(prediction_errors) * (interoceptive_precision + exteroceptive_precision)
                    surprise = gaussian_filter1d(surprise, sigma=3)
                    
                    ax3.plot(time, surprise, 'g-', linewidth=1.5, label='Precision-Weighted Surprise')
                    ...
                    # Add threshold line
                    threshold = parameters.get('threshold', 0.1)
                    ax3.axhline(y=threshold, color='r', linestyle='--', alpha=0.7, label=f'Threshold = {threshold:.3f}')
                    ax3.legend()
                    
                    # Plot 4: Ignition Probability
                    ax4 = axes[1, 1]
                    # Calculate ignition probability based on surprise
                    ignition_prob = 1 / (1 + np.exp(-10 * (surprise - threshold)))  # Sigmoid function
                    
                    ax4.plot(time, ignition_prob, 'm-', linewidth=1.5, label='Ignition Probability')
                    ...
                    for event_idx in ignition_events[::10]:  # Show every 10th event to avoid clutter
                        ax4.scatter(time[event_idx], ignition_prob[event_idx], color='red', s=20, alpha=0.7)
                    ...
                    if self.visualizer:
                        try:
                            ...
                            self.visualizer.create_time_series_plot(
                                ...
                                figure=fig,
                                save_path=os.path.join(self.results_folder, f'time_series_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.png')
                            )
                        except Exception as e:
                            self.log_to_console(f"APGI visualizer failed, using default plot: {e}")
            ...
            for param_name, entry in self.apgi_params.items():
                if param_name in apgi_params:
                    ...
                    if value is not None:
                        ...
                        str_value = str(value)
                        is_valid, validation_error = self.config_validator.validate_parameter(param_name, str_value)
        ...
        try:
            ...
            def run_analysis():
                try:
                    ...
                    self.current_results['surprise_dynamics'] = {
                        'timestamp': datetime.datetime.now().isoformat(),
                        'dynamics': dynamics_results.__dict__ if hasattr(dynamics_results, '__dict__') else dynamics_results,
                        'summary': {
                            'mean_surprise': getattr(dynamics_results, 'mean_surprise', 0.75),
                            'surprise_variance': getattr(dynamics_results, 'surprise_variance', 0.12),
    ...
    def run_disorder_classification(self):
        ...
        try:
            ...
            if not self.current_results:
                ...
                messagebox.showwarning("No Data", "Please run a falsification test first to generate data for classification.")
                self.update_status("Ready")
                return
                ...
                try:
                    ...
                    if self.disorder_classifier:
                        ...
                        self.current_results['disorder_classification'] = {
                            ...
                            'classification': classification_results.__dict__ if hasattr(classification_results, '__dict__') else classification_results,
                            'summary': {
                                'predicted_disorder': getattr(classification_results, 'predicted_disorder', 'None'),
                                'confidence': getattr(classification_results, 'confidence', 0.85),
                        ...
                        # Fallback analysis
                        self.log_to_console("Disorder classifier not available, running basic analysis...")
                        self.current_results['disorder_classification'] = {
                            'timestamp': datetime.datetime.now().isoformat(),
                            'summary': {
                        ...
                        self.after(0, self._on_test_complete, "Disorder Classification", "Basic analysis")
    ...
    def run_clinical_parameter_extraction(self):
        ...
        try:
            ...
            if not self.current_results:
                ...
                messagebox.showwarning("No Data", "Please run a falsification test first to generate data for extraction.")
                self.update_status("Ready")
                return
                ...
                try:
                    ...
                    if self.clinical_extractor:
                        ...
                        self.current_results['clinical_extraction'] = {
                            ...
                            'parameters': extraction_results.__dict__ if hasattr(extraction_results, '__dict__') else extraction_results,
                            'summary': {
                                'apgi_parameters': getattr(extraction_results, 'apgi_parameters', {}),
                                'clinical_indicators': getattr(extraction_results, 'clinical_indicators', []),
                                'severity_score': getattr(extraction_results, 'severity_score', 0.3)
                            }
                        }
                        ...
                        # Fallback analysis
                        self.log_to_console("Clinical extractor not available, running basic analysis...")
                        self.current_results['clinical_extraction'] = {
                            'timestamp': datetime.datetime.now().isoformat(),
                            'summary': {
                        ...
                        self.after(0, self._on_test_complete, "Clinical Parameter Extraction", "Basic analysis")
    ...
    def run_patient_profile_analysis(self):
        ...
        try:
            ...
            profile_data = {
                ...
                'last_assessment': self.current_results.get('timestamp', datetime.datetime.now().isoformat()),
                'risk_factors': [],
                'recommendations': ['Continue monitoring', 'Follow-up assessment recommended']
            }
            ...
            messagebox.showinfo("Profile Analysis", "Patient profile analysis completed successfully.")
            self.update_status("Ready")
