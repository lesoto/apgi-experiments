...
try:
    from apgi_framework.gui.components import (
        MainGUIController, create_main_gui_controller,
        ParameterConfigPanel, TestExecutionPanel, 
        ResultsVisualizationPanel, LoggingPanel
    )
...
class APGIFalsificationGUI(ctk.CTk):
    ...
    def _create_menu(self):
        ...
        file_menu.add_command(label="Export All Results", command=self._export_all_results)
        file_menu.add_separator()
    ...
    def _create_fallback_test_interface(self, parent, test_name: str):
        ...
        ctk.CTkLabel(results_frame, text="Test Results:").pack(anchor="w", padx=10, pady=(10, 5))
    ...
    def _create_results_tab(self):
        ...
        if MODULAR_COMPONENTS_AVAILABLE:
            ...
            self.results_panel = ResultsVisualizationPanel(
                results_tab,
                results_callback=self._on_results_updated
            )
    ...
    def _create_fallback_logs_interface(self, parent):
        ...
        log_scrollbar = ctk.CTkScrollbar(log_frame, command=self.fallback_log_text.yview)
    ...
    def _initialize_system(self):
        ...
        try:
            if MODULAR_COMPONENTS_AVAILABLE:
                ...
                self.system_status_label.configure(text="● System: Ready", text_color="green")
                
                # Add initial log
                if self.logging_panel:
                    self.logging_panel.add_message("Refactored GUI system initialized successfully", "INFO")
                
                logger.info("System initialization completed")
            else:
                self._update_status("System initialized in fallback mode")
                self.system_status_label.configure(text="● System: Fallback Mode", text_color="orange")
    ...
    def _load_configuration(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("Info", "Load configuration not available in fallback mode")
        except Exception as e:
    ...
    def _save_configuration(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("Info", "Save configuration not available in fallback mode")
        except Exception as e:
    ...
    def _export_all_results(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("Info", "Export results not available in fallback mode")
        except Exception as e:
    ...
    def _reset_parameters(self):
        ...
        try:
            if self.parameter_panel:
                ...
                messagebox.showinfo("Info", "Parameter reset not available in fallback mode")
        except Exception as e:
    ...
    def _show_system_status(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("System Status", "Fallback mode - Limited status information")
        except Exception as e:
    ...
    def _validate_system(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("Validation", "System validation not available in fallback mode")
        except Exception as e:
    ...
    def _run_all_tests(self):
        ...
        try:
            if self.main_controller:
                ...
                messagebox.showinfo("Info", "Run all tests not available in fallback mode")
        except Exception as e:
