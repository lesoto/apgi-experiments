"""
Database migration manager for the IPI Framework.
...
class MigrationError(IPIFrameworkError):
...
class MigrationManager:
    """
    Manages database schema migrations for the IPI Framework.
