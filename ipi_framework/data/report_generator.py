"""
Report Generation System for IPI Framework Falsification Testing
...
class ReportGenerator:
    ...
    def _generate_executive_summary(
        ...
        This report presents the results of comprehensive falsification testing of the IPI Framework.
    ...
    def _interpret_falsification(self, falsified_tests: List[FalsificationResult], stats: StatisticalSummary) -> str:
        ...
        **Falsification Detected:**
        ...
        The IPI Framework has been falsified based on {len(falsified_tests)} positive test(s) 
    ...
    def _interpret_no_falsification(self, results: List[FalsificationResult], stats: StatisticalSummary) -> str:
        ...
        **No Falsification Detected:**
        ...
        The IPI Framework was not falsified in any of the {len(results)} tests conducted. 
        ...
        **Strength of Evidence:**
        ...
        the IPI Framework's validity within the tested parameter space.
        """
    ...
    def _generate_conclusions(self, results: List[FalsificationResult], stats: StatisticalSummary) -> str:
        ...
        if falsified_tests:
            conclusion = f"""
            Based on comprehensive falsification testing, the IPI Framework has been falsified 
            ...
            These findings suggest that the IPI Framework requires significant revision 
            or may be fundamentally incorrect in its current formulation.
            """
        else:
            conclusion = f"""
            The IPI Framework successfully passed all {len(results)} falsification tests, 
    ...
    def _generate_summary(self, results: List[FalsificationResult]) -> str:
        ...
        if falsified_count > 0:
            return f"IPI Framework falsified in {falsified_count}/{len(results)} tests"
        else:
            return f"IPI Framework passed all {len(results)} falsification tests"
    ...
    def _format_report_as_text(self, report: FalsificationReport) -> str:
        ...
        text = f"""
IPI FRAMEWORK FALSIFICATION REPORT
==================================
...
<html>
<head>
    <title>IPI Framework Falsification Report - {report.experiment_id}</title>
    <style>
...
<body>
    <h1>IPI Framework Falsification Report</h1>
