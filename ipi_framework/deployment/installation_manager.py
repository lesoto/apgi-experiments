...
required for the IPI Framework parameter estimation system.
"""
...
class InstallationManager:
    """
    Manages automated installation of IPI Framework dependencies.
    ...
    def __init__(self, install_dir: Optional[Path] = None):
        ...
        self.install_dir = install_dir or Path.home() / '.ipi_framework'
    ...
    def install_all_dependencies(self, skip_optional: bool = False) -> InstallationReport:
        ...
        report.success = (report.failed_count == 0 and 
                         all(dep.status != DependencyStatus.NOT_INSTALLED 
                             for dep in report.dependencies.values() if dep.required))
        
        self.logger.info(f"Installation complete: {report.installed_count} installed, "
    ...
    def generate_requirements_file(self, output_path: Path) -> None:
        ...
        with open(output_path, 'w') as f:
            f.write("# IPI Framework Parameter Estimation System Requirements\n")
