...
Validates complete deployment of IPI Framework parameter estimation system
...
class DeploymentValidator:
    """
    Validates deployment of IPI Framework parameter estimation system.
    ...
    def _run_integration_tests(self) -> None:
        ...
        try:
            ...
            try:
                ...
                ipi_params = config.get_ipi_parameters()
                tests_passed += 1
            except Exception as e:
            ...
            try:
                from ipi_framework.deployment import (
                    InstallationManager,
    ...
    def generate_summary(self) -> str:
        ...
        lines = []
        lines.append("=" * 60)
        lines.append("IPI Framework Deployment Validation Summary")
        lines.append("=" * 60)
