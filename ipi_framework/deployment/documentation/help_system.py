...
Provides real-time help and guidance within the IPI Framework GUI.
"""
...
class InSystemHelpSystem:
    """
    Provides context-sensitive help within the IPI Framework GUI.
    ...
    def _define_help_content(self) -> Dict[HelpContext, HelpContent]:
        ...
        content[HelpContext.MAIN_WINDOW] = HelpContent(
            ...
            title="IPI Framework Main Window",
    ...
    def generate_help_index(self) -> str:
        ...
        """
        index = "# IPI Framework Help Index\n\n"
        
        for context, content in sorted(self.help_content.items(), 
