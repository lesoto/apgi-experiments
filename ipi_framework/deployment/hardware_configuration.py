...
used in the IPI Framework parameter estimation system.
"""
...
class HardwareConfigurationManager:
    """
    Manages hardware configuration for the IPI Framework.
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        self.config_dir = config_dir or Path.home() / '.ipi_framework' / 'hardware_configs'
    ...
    def _generate_biosemi_channel_names(self, n_channels: int) -> List[str]:
        ...
        return [f"A{i+1}" for i in range(min(32, n_channels))] + \
    ...
    def configure_eeg_system(self, config_name: str, custom_params: Optional[Dict] = None) -> HardwareDevice:
        """
    ...
    def configure_eye_tracker(self, config_name: str, custom_params: Optional[Dict] = None) -> HardwareDevice:
        """
    ...
    def configure_cardiac_sensor(self, config_name: str, custom_params: Optional[Dict] = None) -> HardwareDevice:
        """
