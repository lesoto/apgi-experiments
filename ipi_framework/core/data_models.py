"""
Core data models for the IPI Framework.
...
@dataclass
class IPIParameters:
    """IPI Framework mathematical parameters."""
...
class ExperimentalTrial:
    ...
    consciousness_assessment: ConsciousnessAssessment = field(default_factory=ConsciousnessAssessment)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'ipi_parameters': self.ipi_parameters.to_dict(),
