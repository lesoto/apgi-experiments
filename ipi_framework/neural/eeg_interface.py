...
for neural data acquisition in IPI experiments.
"""
...
class ArtifactDetector:
    ...
    def detect_gradient_artifacts(self, data: np.ndarray, 
                                  gradient_threshold: float = 50.0) -> np.ndarray:
        """
    ...
    def detect_flatline(self, data: np.ndarray, 
                       window_size: int = 100,
    ...
    def detect_all(self, data: np.ndarray) -> Dict[str, np.ndarray]:
        ...
        return {
            ...
            'any': (self.detect_amplitude_artifacts(data) | 
...
class EEGInterface:
    ...
    for neural data collection in IPI experiments.
    """
    ...
    def set_reference(self, reference_type: str, 
    ...
    def get_channel_impedances(self) -> Dict[str, float]:
        ...
        """
        return {name: ch.impedance for name, ch in self.channels.items() 
    ...
    def check_signal_quality(self) -> Dict[str, any]:
        ...
        high_impedance_channels = [name for name, imp in impedances.items() 
                                   if imp > 10.0]  # > 10 kOhm
