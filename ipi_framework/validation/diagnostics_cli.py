...
def run_health_check(args):
    ...
    print("\n" + "=" * 60)
    print("IPI FRAMEWORK SYSTEM HEALTH CHECK")
    print("=" * 60 + "\n")
...
def run_diagnostics(args):
    ...
    print("\n" + "=" * 60)
    print("IPI FRAMEWORK DIAGNOSTIC INFORMATION")
    print("=" * 60 + "\n")
    ...
    try:
        ...
        print("  IPI Parameters:")
        print(f"    Exteroceptive Precision: {ipi_params.extero_precision}")
        print(f"    Interoceptive Precision: {ipi_params.intero_precision}")
        print(f"    Threshold: {ipi_params.threshold}")
...
def validate_parameters(args):
    ...
    # Validate
    result = validator.validate_ipi_parameters(**params)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="IPI Framework Diagnostics and Validation Tool",
...
Examples:
  ...
  # Run diagnostics
  python -m ipi_framework.validation.diagnostics_cli diagnostics
  
  # Validate parameters
  python -m ipi_framework.validation.diagnostics_cli validate --params extero_precision=2.0 intero_precision=1.5
