...
class DisorderClassification:
    ...
    def extract_neural_signature(self,
        ...
        Args:
            ...
            ipi_params: IPI parameters (threshold, intero_precision, extero_precision, somatic_gain)
        ...
        return NeuralSignatureProfile(
            ...
            threshold=ipi_params.get('threshold', 3.5),
            intero_precision=ipi_params.get('intero_precision', 1.5),
            extero_precision=ipi_params.get('extero_precision', 2.0),
            somatic_gain=ipi_params.get('somatic_gain', 1.2),
    ...
    def get_disorder_specific_signatures(self) -> Dict[DisorderType, Dict[str, float]]:
        ...
        """
        # Based on IPI theory predictions
        signatures = {
            DisorderType.GAD: {
