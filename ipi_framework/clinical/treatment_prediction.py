"""
Treatment prediction module for IPI Framework.

Implements treatment response prediction based on baseline IPI parameters.
"""
...
class BaselineParameters:
    """Baseline IPI parameters for treatment prediction."""
    theta_t: float = 3.5
    pi_e: float = 2.0
    pi_i: float = 1.5
    beta: float = 1.2
