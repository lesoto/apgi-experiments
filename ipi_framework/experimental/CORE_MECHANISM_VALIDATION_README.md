...
This module implements Priority 2 core mechanism validation for the IPI Framework, testing fundamental predictions about how neuromodulatory systems and surprise accumulation dynamics support conscious ignition.
...
from ipi_framework.experimental.example_core_mechanism_validation import (
...
### Strong Support (IPI Framework Validated)
...
from ipi_framework.neural import EEGInterface, ERPAnalysis
...
```
IPI Framework - Priority 2 Core Mechanism Validation
