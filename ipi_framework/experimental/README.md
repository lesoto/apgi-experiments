...
This module provides comprehensive experimental control for the IPI Framework, including multi-modal stimulus presentation, adaptive threshold estimation, and millisecond-precision timing control.
...
**Example:**
```python
from ipi_framework.experimental import MultiModalTaskManager, ModalityType
...
**Example:**
```python
from ipi_framework.experimental import PrecisionTimer, TimingMode
...
**Example:**
```python
from ipi_framework.experimental import TrialSequencer
...
**Example:**
```python
from ipi_framework.experimental import TimingController, TimingMode
...
- **Core IPI Engine**: Provides experimental data for ignition threshold validation
