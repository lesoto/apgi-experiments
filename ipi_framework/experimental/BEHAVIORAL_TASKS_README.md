...
This module implements the three core behavioral tasks for extracting IPI (Ignition, Precision, Interoception) framework parameters:
...
These tasks form the foundation of the IPI parameter estimation pipeline, enabling rapid (~45-60 minute) individualized quantification of key computational parameters through a combination of behavioral measurements, EEG analysis, and pupillometry.
...
### Usage Example
```python
from ipi_framework.experimental import DetectionTask
...
### Usage Example
```python
from ipi_framework.experimental import HeartbeatDetectionTask
...
### Usage Example
```python
from ipi_framework.experimental import DualModalityOddballTask
...
```python
from ipi_framework.experimental import (
    DetectionTask,
...
from ipi_framework.data import ParameterEstimationDAO
...
```bash
python -m ipi_framework.experimental.example_behavioral_tasks
```
...
See the main IPI framework documentation for theoretical background and validation studies.
