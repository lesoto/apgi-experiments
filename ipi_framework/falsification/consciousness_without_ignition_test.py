...
class ConsciousnessWithoutIgnitionTest:
    ...
    def run_consciousness_without_ignition_test(self, 
                                              ...
                                              test_id: Optional[str] = None) -> ConsciousnessWithoutIgnitionTestResult:
        """
    ...
    def _run_single_trial(self, trial_id: str, participant_id: str) -> ConsciousnessWithoutIgnitionTrialResult:
        ...
        return ConsciousnessWithoutIgnitionTrialResult(
            ...
            metacognitive_sensitivity=consciousness_assessment['metacognitive_sensitivity'],
    ...
    def _validate_absent_signatures(self, signatures: Dict) -> Dict:
        ...
        gamma_absent = (signatures['gamma_plv'] < self.gamma_absent_plv and 
                       signatures['gamma_duration'] < self.gamma_absent_duration)
        
        # Check BOLD activation in frontoparietal regions
        frontoparietal_regions = ['dlpfc_left', 'dlpfc_right', 'ips_left', 'ips_right']
        bold_absent = all(signatures['bold_activations'].get(region, 0) < self.bold_absent_z 
    ...
    def _calculate_metacognitive_sensitivity(self, accuracy: float, confidence: float) -> float:
    ...
    def _determine_falsification(self, signature_validation: Dict, 
        ...
        """
        return (signature_validation['all_absent'] and
                consciousness_assessment['consciousness_present'] and
                controls_valid)
    ...
    def _analyze_results(self, test_id: str, 
                        ...
                        n_trials: int, n_participants: int) -> ConsciousnessWithoutIgnitionTestResult:
        ...
        for participant_id, trials in participant_results.items():
            ...
            participant_rate = len(participant_falsifying) / len(trials)
        ...
        p_value = self._calculate_p_value(falsification_rate, total_falsifying, len(trial_results))
        ...
        interpretation = self._generate_interpretation(
            ...
            participants_with_falsification, n_participants
        )
    ...
    def _calculate_p_value(self, falsification_rate: float, 
                          n_falsifying: int, n_total: int) -> float:
    ...
    def _generate_interpretation(self, falsification_rate: float, 
                               is_falsified: bool, total_falsifying: int,
                               participants_with_falsification: int,
                               n_participants: int) -> str:
        """Generate interpretation of results"""
        if is_falsified:
            return (f"FRAMEWORK FALSIFIED: {total_falsifying} trials ({falsification_rate:.1%}) "
                   ...
                   f"the IPI Framework's prediction that consciousness requires ignition.")
        elif falsification_rate > 0.1:
            return (f"PARTIAL FALSIFICATION: {total_falsifying} trials ({falsification_rate:.1%}) "
