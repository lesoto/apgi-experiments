"""
Core statistical testing framework for IPI falsification testing.
...
comparisons correction for validating IPI framework falsification criteria.
"""
...
class StatisticalTester:
    ...
    def cluster_correction(self, 
                          p_values: np.ndarray,
                          cluster_threshold: float = 0.05,
                          min_cluster_size: int = 1) -> ClusterCorrectionResult:
        """
    ...
    def _calculate_eta_squared(self, groups: Tuple[np.ndarray, ...], 
                              f_statistic: float, df_between: int, df_within: int) -> float:
    ...
    def _calculate_rank_biserial_correlation(self, group1: np.ndarray, 
                                           group2: np.ndarray, u_statistic: float) -> float:
    ...
    def _calculate_matched_pairs_rank_biserial(self, differences: np.ndarray, 
                                             w_statistic: float) -> float:
    ...
    def _calculate_epsilon_squared(self, groups: Tuple[np.ndarray, ...], 
                                  h_statistic: float) -> float:
