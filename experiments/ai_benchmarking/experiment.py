...
class AIBenchmarkingExperiment(BaseExperiment):
    ...
    def run_experiment(self, **kwargs):
        ...
        for episode in range(self.config.n_episodes):
            ...
            print(f"Episode {episode + 1}/{self.config.n_episodes} completed in {episode_time:.1f}s")
    ...
    def _run_episode(self, env: GridWorld, agents: Dict[str, List[Any]], episode: int) -> Dict:
        ...
        for step in range(self.config.max_steps):
            ...
            all_done = all(not agent.active for agent_list in agents.values() for agent in agent_list)
            if all_done:
                break
    ...
    def _analyze_results(self):
        ...
        self._plot_metric_over_episodes('survival_times', 'Mean Survival Time', 'Time Steps', plots_dir)
        
        # Plot food consumed over episodes
        self._plot_metric_over_episodes('food_consumed', 'Mean Food Consumed', 'Count', plots_dir)
        
        # Plot final energy over episodes
        self._plot_metric_over_episodes('final_energy', 'Mean Final Energy', 'Energy', plots_dir)
        
        # Plot summary bar charts
        self._plot_summary_barcharts(plots_dir)
    
    def _plot_metric_over_episodes(self, metric: str, title: str, ylabel: str, save_dir: str):
    ...
    def _plot_summary_barchart(self, summary: Dict, metric: str, error_metric: str, 
                             ylabel: str, filename: str, save_dir: str):
...
def run_ai_benchmarking_experiment(**kwargs):
    ...
    arg_mapping = {
        'n_participants': 'n_agents_per_type',
        'n_trials': 'n_episodes'
    }
