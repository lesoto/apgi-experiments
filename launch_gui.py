...
class GUILauncher:
    ...
    def create_widgets(self):
        ...
        full_gui_frame = ttk.LabelFrame(options_frame, text="Full-Featured GUI", padding="15")
        full_gui_frame.pack(fill=tk.X, pady=10)
        
        ttk.Label(full_gui_frame, text="GUI.py", font=('Arial', 11, 'bold')).pack(anchor=tk.W)
        ttk.Label(full_gui_frame, text="• Complete APGI Framework interface").pack(anchor=tk.W, pady=(5, 0))
        
        # Buttons for full GUI
        button_frame = ttk.Frame(full_gui_frame)
        button_frame.pack(fill=tk.X, pady=(10, 0))
        
        select_full_button = ttk.Button(button_frame, text="Select", command=self.select_full_gui)
        select_full_button.pack(side=tk.LEFT)
        
        # Simple GUI option
        simple_gui_frame = ttk.LabelFrame(options_frame, text="Simple GUI", padding="15")
        simple_gui_frame.pack(fill=tk.X, pady=10)
        
        ttk.Label(simple_gui_frame, text="GUI-Simple.py", font=('Arial', 11, 'bold')).pack(anchor=tk.W)
        ttk.Label(simple_gui_frame, text="• Streamlined interface").pack(anchor=tk.W, pady=(5, 0))
        
        # Buttons for simple GUI
        button_frame = ttk.Frame(simple_gui_frame)
        button_frame.pack(fill=tk.X, pady=(10, 0))
        
        select_simple_button = ttk.Button(button_frame, text="Select", command=self.select_simple_gui)
    ...
    def launch_full_gui(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location("gui_template", current_dir / "GUI.py")
    ...
    def launch_simple_gui(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location("template_gui", current_dir / "GUI-Simple.py")
