...
IS_AUTOMATED = bool(
    ...
    or os.getenv("CI_BUILD")
    or os.getenv("BUILD_NUMBER")
    or os.getenv("TF_BUILD")
    or os.getenv("GOCD_SERVER_URL")
    or os.getenv("WERCKER")
    or os.getenv("CODEBUILD_BUILD_ID")
    or os.getenv("SHIPPABLE")
    or os.getenv("DRONE")
    or os.getenv("HEROKU_TEST_RUN_ID")
    or os.getenv("NOW_BUILDER")
    or os.getenv("VERCEL")
    ...
    or not sys.stdin.isatty()  # Also consider non-interactive stdin as automated
)
