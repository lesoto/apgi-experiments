...
class CodeSandbox:
    ...
    def __init__(self, 
        ...
        self.forbidden_modules = {
            ...
            'dbm', 'sqlite3', 'eval', 'exec', 'compile', '__import__',
            'open', 'file', 'input', 'raw_input', 'help', 'credits'
        }
        
        self.forbidden_functions = {
            'eval', 'exec', 'compile', '__import__', 'reload',
            'globals', 'locals', 'vars', 'dir', 'hasattr', 'getattr',
            'setattr', 'delattr', 'callable', 'isinstance', 'issubclass', 'open'
        }
    ...
    def validate_code(self, code: str) -> bool:
        ...
        validator = SecurityValidator(self.allowed_modules, self.forbidden_modules, self.forbidden_functions)
...
class SecurityValidator(ast.NodeVisitor):
    ...
    def __init__(self, allowed_modules: List[str], forbidden_modules: set, forbidden_functions: set):
    ...
    def visit_Import(self, node):
        ...
        for alias in node.names:
            ...
            if alias.name in self.forbidden_modules or any(forbidden in alias.name for forbidden in self.forbidden_modules):
