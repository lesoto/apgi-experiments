    ...
    class SessionManagementGUI(StandardWindow):
        ...
        def create_session_tab(self):
            ...
            info_frame = ttk.LabelFrame(
                session_frame, text="Session Information", padding=10
            )
            info_frame.pack(fill="x", padx=10, pady=10)

            # Session ID
            ttk.Label(info_frame, text="Session ID:").grid(
            ...
            create_standard_button(
                info_frame, "Generate", self.generate_session_id
            ).grid(row=0, column=2, pady=5)

            # Participant ID
            ttk.Label(info_frame, text="Participant ID:").grid(
            ...
            # Session type
            ttk.Label(info_frame, text="Session Type:").grid(
        ...
        def create_participant_tab(self):
            ...
            ttk.Entry(
                info_frame, textvariable=self.new_participant_id_var, width=30
            ...
            ttk.Spinbox(
                info_frame, from_=18, to=100, textvariable=self.age_var, width=28
            ).grid(row=1, column=1, sticky="w", pady=5, padx=5)

            # Gender
            ttk.Label(info_frame, text="Gender:").grid(
                row=2, column=0, sticky="w", pady=5
            )
        ...
        def create_button_frame(self):
            ...
            create_standard_button(
                button_frame, "Create Session", self.create_session
            ).pack(side="left", padx=5)
            create_standard_button(
                button_frame, "Save Session", self.save_session
            ).pack(side="left", padx=5)
            create_standard_button(
                button_frame, "Load Session", self.load_session
            ).pack(side="left", padx=5)
        ...
        def add_participant(self):
            ...
            if (
                self.participant_manager
                and participant_id in self.participant_manager.participants
            ):
        ...
        def create_session(self):
            ...
            if self.session_manager:
                try:
                    ...
                    show_info_dialog(
                        "Success", f"Session {session_id} created successfully"
                    )
