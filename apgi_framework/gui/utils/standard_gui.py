...
class GUIStyleManager:
    ...
    def _configure_tkinter_style(cls, root: tk.Tk) -> None:
        ...
        style.configure("TLabelframe", background=cls.COLORS["background"], foreground=cls.COLORS["text"])
...
def create_standard_button(parent: tk.Widget, text: str, command: Callable, **kwargs) -> ttk.Button:
