...
class RealTimeDataStreamer:
    ...
    def _run_server(self):
        ...
        try:
            ...
            loop.run_until_complete(self._streaming_loop())
    ...
    def _generate_eeg_data(self, timestamp: float) -> EEGStreamData:
        ...
        artifact_rate = np.random.beta(1, 9) if np.random.random() < 0.1 else 0  # Occasional artifacts
    ...
    def stop_server(self):
        ...
        if self.server:
            # Note: Proper cleanup would require access to the server loop
            pass
