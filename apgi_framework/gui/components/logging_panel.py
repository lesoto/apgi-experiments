...
class LoggingPanel(ctk.CTkFrame):
    ...
    def _process_log_message(self, message: str):
        ...
        try:
            ...
            parts = message.split(" - ")
            if len(parts) >= 4:
                timestamp, logger_name, level, log_content = parts[0], parts[1], parts[2], " - ".join(parts[3:])
    ...
    def _append_formatted_log(self, timestamp: str, logger_name: str, level: str, content: str):
