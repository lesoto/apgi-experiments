...
from ..exceptions import (
    APGIFrameworkError, ValidationError, SimulationError,
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            try:
                ...
                recovery_manager = get_recovery_manager()
                recovery_manager.log_error(e, context)
                raise APGIFrameworkError(f"Memory error in {func_name}: Insufficient memory. Try reducing data size.") from e
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        if callable(attr) and name.startswith('run_'):
            ...
            def wrapped_method(*args, **kwargs):
                ...
                raise APGIFrameworkError(f"Max attempts ({max_attempts}) exceeded for {name}")
