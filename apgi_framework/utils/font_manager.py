...
class FontManager:
    ...
    def _detect_available_fonts(self) -> List[str]:
        ...
        try:
            ...
            for font_name in font_families:
                ...
                if any(skip in font_name.lower() for skip in [
                    'symbol', 'dingbat', 'webding', 'wingding', 
                    'braille', 'cursor', 'marlett'
                ]):
                    continue
    ...
    def get_font(self, font_type: str = 'ui', size: int = 12, 
                 weight: str = 'normal', slant: str = 'roman') -> tkFont.Font:
        """
    ...
    def get_best_font_for_text(self, text: str, font_type: str = 'ui', 
                             size: int = 12) -> Tuple[str, tkFont.Font]:
        """
...
def configure_widget_fonts(widget: tk.Widget, font_type: str = 'ui', 
