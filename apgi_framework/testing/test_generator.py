...
'''
    ...
    def _discover_python_modules(self, root_path: Path) -> List[Path]:
        ...
        skip_dirs = {'tests', 'test', '__pycache__', '.git', '.pytest_cache', 'venv', 'env'}
    ...
    def _identify_coverage_gaps(self, module_analysis: Dict[str, Any]) -> List[TestCoverageGap]:
    ...
    def _is_method_tested(self, method: Dict[str, Any], cls: Dict[str, Any], module_analysis: Dict[str, Any]) -> bool:
    ...
    def _calculate_suite_metrics(self, codebase_analysis: Dict[str, Any]) -> TestSuiteMetrics:
        """Calculate overall test suite metrics."""
        total_modules = len(codebase_analysis['modules'])
        tested_modules = sum(1 for mod in codebase_analysis['modules'].values() 
    ...
    def generate_missing_tests(self, codebase_analysis: Dict[str, Any], output_dir: str = "generated_tests") -> Dict[str, str]:
...
'''
        ...
        methods = [gap for gap in gaps if '.' in gap.function_name and gap.function_type == 'method']
    ...
    def generate_coverage_report(self, codebase_analysis: Dict[str, Any], output_file: str = "coverage_report.md") -> str:
