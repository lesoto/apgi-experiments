...
class BatchTestRunner:
    ...
    def discover_tests(self, 
                      ...
                      keywords: Optional[str] = None) -> List[str]:
    ...
    def run_batch_tests(self,
                       ...
                       failfast: bool = False) -> BatchExecutionSummary:
        ...
        self.logger.info(f"Batch execution completed in {total_duration:.2f}s: "
    ...
    def generate_report(self, summary: BatchExecutionSummary, 
...
def run_all_tests(parallel: bool = True, max_workers: Optional[int] = None) -> BatchExecutionSummary:
...
def run_failed_tests(previous_results_file: str, parallel: bool = True) -> BatchExecutionSummary:
    ...
    failed_tests = [
        result['test_file'] for result in previous_data['test_results']
    ...
    if not failed_tests:
        ...
        return BatchExecutionSummary(
            ...
            total_duration=0.0, start_time=datetime.now(), end_time=datetime.now(),
